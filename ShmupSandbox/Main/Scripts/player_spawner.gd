...
func _connect_to_signals() -> void:
	SignalsBus.player_death_event.connect(_on_player_death)
	SignalsBus.player_spawn_event.connect(_on_player_spawn)
	SignalsBus.continue_game_player_respawn_event.connect(_on_continue_game_player_respawn)
